...
export const studentProfiles: StudentProfile[] = [
...

  {
    name: "张亦舒",
    hometown: "浙江金华",
    phoneNumber: "18058951238",
    email: "2743113247@qq.com",
    skills: ["ps", "ai", "ae", "id", "c4d"],
    selfEvaluation: "性格开朗，认真好学，兴趣广泛，有责任心",
    practicalExperience: [
      "在教育机构和艺术培训机构进行教书、教学"
    ],
...

  {
    ...
    skills: ["ps", "ai", "ae", "id", "procreate"],
    selfEvaluation: "性格开朗，乐于助人热心公益事业",
    practicalExperience: [
      "2022亚运会优秀志愿者",
      "艺术培训机构实践教学"
    ],
    studentNumber: "21048124"
  },
...

  {
    ...
    skills: ["ps", "ai", "ae", "id", "fl", "pr", "xd", "an", "au"],
    ...
    practicalExperience: [
      "2021年到2023年在逗号学堂，育桃李培训机构进行绘画教学"
    ],
    personalAwards: [
      "2022广告设计市赛二等奖",
...

  {
    ...
    skills: ["Ps", "AI", "Ae", "An", "Id", "Pr", "Procreate"],
...

  {
    ...
    practicalExperience: [
      "2022年到2023年在",
      "第十五届全国大学生广告艺术大赛平面类三等奖",
      "浙江省第十一届大学生广告创意设计竞赛平面类二等奖",
      "绍兴市第七届大学生文创产业与艺术设计竞赛ip二等奖",
